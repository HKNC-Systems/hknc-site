        ...
        r(document)
          ...
          .on('keyup change', '.form-control', function () {
            ...
            ('' === t.val()
              ...
              i && (a ? e.removeClass('has-error') : e.addClass('has-error')));
          })
      ...
      (l.hestia = {
        ...
        scrollToTop: function () {
          ...
          (l(window).on('scroll', function () {
            ...
            (e < t &&
              0 === a &&
              (l('.hestia-scroll-to-top').addClass('hestia-fade'), (a = 1)),
              t < e &&
                1 === a &&
        ...
        setControlLabel: function () {
          ...
          if (void 0 !== a) {
            ...
            ('' === l(i).attr('value')
              ...
              l.utilitiesFunctions.addControlLabel(i));
          }
      ...
      (l.navigation = {
        ...
        activeParentLink: function () {
          l('.navbar .dropdown > a').click(function () {
            return (
              '#' === l(this).attr('href') || (location.href = this.href),
              !1
            );
          });
        },
